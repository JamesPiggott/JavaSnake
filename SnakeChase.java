...
public class SnakeChase extends JFrame implements Runnable
{
  ...
  // The keyboard input is saved as direction
  public int direction;


  public SnakeChase(long period) 
  {
    super("Worm Chase");
    ...
    fred = new Snake(pWidth, pHeight, obs);
...
*/
  ...
  */
  ...
  {  
    ...
    new SnakeChase(period*1000000L);    // ms --> nanosecs
  }  // end of main()
